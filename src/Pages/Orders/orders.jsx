...
//   ) : (
//     <tr>
//       <td colSpan="8" className="border p-4 text-center text-red-500">
//         No Results Found
//       </td>
...
import { Link } from 'react-router-dom';
import StatCard from '../../Components/StatCrad';
import { FaGem, FaRegClock, FaCheckCircle, FaTimesCircle } from 'react-icons/fa';
import Pagination from '../../Components/Pagination';
import mockData from './mockData';  // Import the mock data
      ...
      <table className="table-auto w-full border-collapse border bg-white shadow-lg rounded-xl">
        <thead>
          <tr>
            <th className="border p-2">No</th>
            <th className="border p-2">Order ID</th>
            <th className="border p-2">Jewellary Item</th>
            <th className="border p-2">Address</th>
            <th className="border p-2">Date</th>
        ...
        <tbody>
          {currentOrders.length > 0 ? (
            currentOrders.map((order, index) => (
              <tr key={order.id}>
                ...
                <td className="border p-2">
                  ...
                  {/* Action buttons, such as Mark as Shipped */}
                  {order.status === 'Processing' && (
                    <button className="ml-2 text-green-500 hover:text-green-700">Mark as Shipped</button>
                  )}
                </td>
              </tr>
            ))
            ...
            <tr>
              <td colSpan="9" className="border p-4 text-center text-red-500">
                No Orders Found
              </td>
            </tr>
          )}
